...
add_song(my_playlist, {"artist": "name", "title": "string"})
...
add_song(my_playlist, {"artist": "little Wayne", "title": "Always strapped"})
add_song(my_playlist, {"artist": "Jermey Camp", "title": "Walk by faith"})
